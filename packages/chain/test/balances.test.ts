...
describe("balances", () => {
  it("should demonstrate how adding balance work", async () => {
...
it("should demonstrate how removing balance work", async () => {
  const appChain = TestingAppChain.fromRuntime({
    Balances,
  });
  ...
  const tx2 = await appChain.transaction(alice, () => {
    balances.removeBalance(tokenId, alice, UInt64.from(500));
  });
